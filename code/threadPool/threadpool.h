...
private:
    mtx mtxPool;       // 互斥锁
    cond condNotEmpty; // 条件变量
    int threadNum;     // 线程的数量
    int maxRequests;   // 最大连接数
    bool shutdown;     // 是否关闭
    // function<void>可代替函数指针，使用 bind 将函数指针与参数绑定
